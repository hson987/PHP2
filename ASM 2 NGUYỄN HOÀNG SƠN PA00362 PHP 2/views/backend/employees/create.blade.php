...
@section('title', 'Thêm nhân viên mới - Z DEMO')
...
<div class="max-w-xl mx-auto space-y-6">
    ...
    <div class="space-y-1">
        <nav class="flex text-xs text-slate-400 items-center space-x-2">
            ...
            <i class="fa-solid fa-chevron-right text-[9px]"></i>
            <span class="text-slate-950 font-semibold">Thêm nhân viên mới</span>
        </nav>
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden p-6 md:p-8">
        <form action="{{ BASE_URL }}/admin/employee/add" method="POST" class="space-y-5 text-xs font-semibold text-slate-700">
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative flex items-center">
                    ...
                    <input type="email" name="email" id="email" required placeholder="staff@fpt.edu.vn" class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 focus:bg-white focus:border-emerald-500 outline-none rounded-2xl transition">
                </div>
            </div>
