...
@section('title', 'Sửa Danh mục - Admin Z DEMO')
@section('content')
<div class="max-w-xl mx-auto space-y-6">
    ...
    <nav class="flex text-sm text-slate-500 items-center space-x-2">
        ...
        <span class="text-slate-900 font-medium">Sửa danh mục #{{ $category['id'] }}</span>
    </nav>
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
        ...
        <form method="POST" action="{{ BASE_URL }}/admin/category/edit/{{ $category['id'] }}" class="space-y-6">
            ...
            <div>
                ...
                <p class="text-[10px] text-slate-400 mt-1.5 leading-relaxed">
                    * Viết thường không dấu, không khoảng trắng, chỉ dùng chữ cái, chữ số và dấu gạch dưới `_`.
                </p>
            </div>
